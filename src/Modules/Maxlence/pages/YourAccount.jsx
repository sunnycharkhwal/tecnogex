...
export const YourAccount = () => {
  ...
  const Form = () => {
    ...
    const FormApp1 = (props) => {
      return (
        <div className="account_input_title_top">
          <MdOutlineEdit onClick={()=> setForm1disable(!form1disable)} className="account_edit_icon" />
    ...
    const FormApp2 = (props) => {
      return (
        <div className="account_input_title_top">
          <MdOutlineEdit onClick={()=> setForm2disable(!form2disable)} className="account_edit_icon" />
          <div className="account_input_title">
            <h3>{props.formTitle}</h3>
          </div>
          <div className="account_input_title_top_inner">
